document.addEventListener('DOMContentLoaded', function() {
    ...
    if (galleryGrid) {
        console.log('Collection page detected. Setting up...');
        
        // Make openArtworkViewer global
        window.openArtworkViewer = function(button) {
            console.log('openArtworkViewer called');
            const card = button.closest('.artwork-card');
            if (!card) {
                console.error('No artwork card found');
                return;
            }
            
            const artworkDataStr = card.getAttribute('data-artwork');
            if (!artworkDataStr) {
                console.error('No data-artwork attribute');
                return;
            }
            ...
            try {
                ...
                const url = `artwork-detail.html?${queryString}`;
        ...
        // Event delegation for view buttons - MUST BE ON DOCUMENT, NOT INSIDE IF BLOCK
